...
function SourceBox( {id} ) {
    ...
    function showSource(event) {
        if (event.target.id === "btnbattleDeaths") {
            ...
            Det viser UCDPs estimat for "battle-related deaths" - altså hvor mange som har blitt drept i forbindelse med kamper.</p> 

            <p><strong>Kreditering: </strong> UCDP Uppsala Conflict Data Program, Pettersson, Therese & Magnus Öberg (2020) 
            Organized violence, 1989-2019. Journal of Peace Research 57(4).<p/>
            ...
            refBox.innerHTML = `
            <p>Tallene i statistikken er hentet fra Flyktninghjelpens flyktningregnskap 2020. </p>
            ...
            <a href="https://www.flyktninghjelpen.no/flyktningregnskapet" target="blank">Gå til kilden</a>
            `
        }
    }
    ...
    return(
        <>
        <button id={"btn"+id} onMouseEnter={showSource} onMouseLeave={hideSource}>Se kilde</button>
